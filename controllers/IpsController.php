...
class IpsController extends Controller 
{
    ...
    public function index()
    {
        ...
        $this->_view->titulo = "Modulo de Proveedor del Servicio de Internet";
        $this->_view->render('index', 'ips');
    ...
    private function _urls()
    {
        ...
        $this->_view->pronavegacion = "Módulo IPS";
    }

    public function catalogo()
    {
        $this->_view->ips = self::_obtenerCatalogo();
        $this->_view->navegacion ="Catálogo de IPS";
        $this->_view->titulo = "Catálogo de IPS";
        $this->_view->render('catalogo', 'ips');
    }
    ...
    private function _obtenerCatalogo()
    {

      $ips = $this->_ips->getIPS();
      return $ips;
   ...
   */
    ...
    $texto =
      ...
      */
      $marca = "Shenzhen ZCS Technology";
      $modelo = "Smart POS Z91";
      $serie = "82418120400733";
      $procesador = "Qualcomm Quad-Core ARM Cortex-A7 Processor";
      $sucursal = $depa. ", Palenque";
      $ram = "1 Gb";
      $flash="8 Gb";
      $os = "Android 5.1";
