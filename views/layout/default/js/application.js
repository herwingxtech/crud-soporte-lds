...
================================================== */
	...
	$("#loading-data").select2({
		placeholder: "Ingresa al menos un caracter",
        allowClear: true,
...
================================================== */
	...
	$(".validate").validate({
		...
		rules: {
			...
			pass_user: "required",
			nombre_user: { minlength:4,},
			pass_user: { minlength:6,},
			group_styled: {
				required: true,
				minlength: 4
			},
		...
		messages: {
			...
			nombre_user: {
				required: "El campo usuario está vacío",
			},

			pass_user: {
				required: "El campo contraseña está vacío",
			},
			agree: "Por favor acepta nuestras políticas"
		},
